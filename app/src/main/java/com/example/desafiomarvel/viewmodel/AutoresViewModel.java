...
import com.example.desafiomarvel.model.repository.CriadoresRepositpory;
...
public class AutoresViewModel extends AndroidViewModel {
    ...
    private CriadoresRepositpory repositpory = new CriadoresRepositpory();
    ...
    public void getCriadores() {
        ...
        disposable.add(
                repositpory.getPersonagemRepositori("suffix", ts, hash, PUBLIC_KEY)
